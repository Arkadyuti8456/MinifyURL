      ...
      <section className="grid grid-cols-2 h-[50vh]">
        <div className="flex flex-col gap-4 items-center justify-center">
          ...
          <p className="px-16 text-center">
            We are the most straight forward URL shortener in the world. Most of the shorteners will track you or ask you to give your details for login. We understand your needs and hence we have created this URL shortener
          </p>
